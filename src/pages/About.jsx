    ...
    <>
      {screenWidth >= "1024" ? (
        ...
        >
          ...
          <div className="w-full ml-20">
            <div className="sm:w-sm md:w-md lg:w-lg w-5/12 mb-6">
              ...
              <p className="text-lg text-neu-0">
                ...
                the role of a UI design intern at a small start up company where
                I became immersed in the technology and process of building
                ...
                <br></br>
                <br></br>
                As my role progressed into a UI production team lead I learned
                to manage large projects, striving to meet or beat deadlines.
                <br></br>
                <br></br>
                In 2023 I enrolled in a full stack coding bootcamp course to
                learn more about the engineering side of software developement.
                I excell in problem solving. Having several years of experience
                in UI Design and dynamic feature flows enhance my understanding
                of requirements and what it takes to fulfill AC.
              </p>
            </div>
            {/* button group */}
          ...
          >
            ...
            <img
              ...
              className="2xl:right-[304px] xl:right-[200px] lg:right-[100px]   sm:right-[40px] bottom-60 absolute rounded-full shadow-xl w-[400px] "
            ></img>
          </div>
        </div>
      ) : (
        ...
        >
          <img
            src="assets/images/profile-alt.png"
            className=" rounded-full lg:w-5/12 md:w-6/12 w-8/12  mx-auto "
          ></img>
          <h1
            className={`mb-1   font-black text-neu-0  ${
              screenWidth >= "400" ? "text-[64px] leading-[75px]" : "text-h1"
            }`}
          >
            Jeffrey Gunn
          </h1>
          <div className="flex text-pri-3 gap-1 mb-6 justify-center">
            <h3 className="text-h3 font-bold">UI Design</h3>
            <h3 className="text-h3 font-bold">-</h3>
            <h3 className="text-h3 font-bold">Web Development</h3>
          </div>
          <p className="text-lg text-neu-0 sm:px-20 px-10 ">
            I started my career in the tech industry in 2018 when I took on the
            role of a UI design intern at a small start up company where I
            became immersed in the technology and process of building software.
            Over time I had begin to learn more about and participate in other
            roles in the development process like QA, Product Ownership, and
            Project Management.
            <br></br>
            <br></br>
            ...
            in problem solving. Having several years of experience in UI Design
            and dynamic feature flows enhance my understanding of requirements
            and what it takes to fulfill AC.
          </p>
        </div>
      )}
    </>
